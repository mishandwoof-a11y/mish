export default function Footer({ sesionActual }) {
    ...
    <footer>
      <section className="whatsapp-cta">
        <div className="whatsapp-cta__inner">
          <span className="whatsapp-cta__emoji">🐾</span>
          <p className="whatsapp-cta__title">
            Encontrá todos estos balanceados y más en <strong>Mish&amp;Woof</strong>
          </p>
          <p className="whatsapp-cta__sub">Consultanos y te ayudamos a elegir el mejor para tu mascota</p>
          <a
            href={getWhatsAppUrl()}
            target="_blank"
          ...
          >
            <svg className="whatsapp-icon" viewBox="0 0 32 32" fill="currentColor" aria-hidden="true">
      ...
      <div className="footer">
        <strong>Mish&amp;Woof</strong> Pet Shop · Todos los derechos reservados
      </div>
    </footer>
  )
}
